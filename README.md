...
Repositório criado para organizar e disponibilizar o material de apoio e os slides das aulas do curso de Análise e Desenvolvimento de Sistemas (ADS). O foco principal é acesso rápido, leitura otimizada e exportação fácil para PDF.

## 🚀 Acesso

O portal é renderizado de forma estática pelo GitHub Pages.

## 📁 Estrutura do Projeto

Para facilitar a manutenção, o projeto utiliza recursos compartilhados:

- `/assets/css/`: Folhas de estilo (o design de todas as aulas puxa daqui).
...
- `/[1-6]-semestre/[nome-da-materia]/`: Pasta de cada disciplina.
  ...
  - `aula-*.html`: Apresentações interativas (Slides da aula).

## 🛠️ Como adicionar novas aulas

1. Acesse a pasta do semestre e da matéria desejada.
2. Crie um novo arquivo HTML para a aula (basta duplicar a `aula-01-disrupcao.html` e trocar o texto do conteúdo).
